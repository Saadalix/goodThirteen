...
The Setup: You start with 10 cards dealt face-up from a shuffled 52-card deck.

Removing Cards: You can remove cards from your hand in two ways:
...
Refilling: Every time you remove cards, the game automatically draws new cards from the deck to refill your hand back to 10.

Winning: You win if you successfully remove all 52 cards.

Losing: The game is over if no more combinations of 13 can be made and the deck is empty.
...
git clone https://github.com/Saadalix/goodThirteen.git
cd goodThirteen
